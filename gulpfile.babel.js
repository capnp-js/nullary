...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-nullary.js",
      format: "umd",
      name: "capnpJsNullary",
      sourcemap: true,
      globals: {},
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-nullary.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-nullary.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-nullary.js.map",
            },
          }))
